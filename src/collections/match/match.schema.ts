...
const userMatchSchema = {
  sender: { type: ObjectId, ref: BlCollectionName.UserDetails, default: undefined },
  receiver: { type: ObjectId, ref: BlCollectionName.UserDetails, default: undefined },
  // items which are expected to be handed over from sender to receiver
  expectedItems: { type: [ObjectId], ref: BlCollectionName.Items, default: undefined},
  ...
  deliveredCustomerItems: { type: [ObjectId], ref: BlCollectionName.CustomerItems, default: undefined },
  // items which have been received by the receiver from anyone
  receivedCustomerItems: { type: [ObjectId], ref: BlCollectionName.CustomerItems, default: undefined},
};
...
const standMatchSchema = {
  ...
  receivedItems: { type: [ObjectId], ref: BlCollectionName.Items, default: undefined},
  // items the customer has handed off to stand
  deliveredItems: { type: [ObjectId], ref: BlCollectionName.Items, default: undefined},
  // items which are expected to be handed off to stand
  expectedHandoffItems: { type: [ObjectId], ref: BlCollectionName.Items, default: undefined},
  // items which are expected to be picked up from stand
  expectedPickupItems: { type: [ObjectId], ref: BlCollectionName.Items, default: undefined},
};
 ...
 */
export const matchSchema = {...matchBaseSchema, ...standMatchSchema, ...userMatchSchema}
