...
export class CollectionEndpointCreator {
	...
	create() {
		const collectionEndpoints: CollectionEndpoint<BlDocument>[] = [
			...
			new CollectionEndpoint<BranchItem>(this._router, new BranchItemCollection()),
			new CollectionEndpoint<CustomerItem>(this._router, new CustomerItemCollection()),
			...
			new CollectionEndpoint<OpeningHour>(this._router, new OpeningHourCollection()),
