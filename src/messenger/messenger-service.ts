import {Order, UserDetail, Message, CustomerItem} from "@wizardcoder/bl-model";
...
export interface MessengerService {
	...
	remind(message: Message, customerDetail: UserDetail, customerItems: CustomerItem[]): void;
