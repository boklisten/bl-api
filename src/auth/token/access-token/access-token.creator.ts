...
export class AccessTokenCreator {
	...
	public create(username: string, userid: string, permission: UserPermission, userDetailId: string, refreshToken: string): Promise<string> {
	...
	private createPayload(username: string, userid: string, permission: UserPermission, userDetailId: string) {
		return {
